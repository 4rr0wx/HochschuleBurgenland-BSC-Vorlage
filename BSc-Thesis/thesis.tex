...
\newpage
\pagestyle{empty} % oder plain für normale Nummerierung beibehalten
\null 
\newpage
...
\input{thesis_chapters/02_Grundlagen/_main.tex}
\input{thesis_chapters/03_Vorgangsweise_und_Methoden/_main.tex}
\input{thesis_chapters/04_Empirische_Teil/_main.tex}
\input{thesis_chapters/05_Ergebnisse_und_Schlussfolgerung/_main.tex}
